...
#include <objects_detection_action/AveragingAction.h>
//Debug
#include <ctime>
...
public:
  ...
  void goalCB()
  {
    ...
    ROS_INFO("%d: Received new goal",goal_);
    usleep(50000);
  }
...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<objects_detection_action::AveragingAction> as_;
  std::string action_name_;
  int data_count_, goal_;
  float sum_, sum_sq_;
  objects_detection_action::AveragingFeedback feedback_;
  objects_detection_action::AveragingResult result_;
  ros::Subscriber sub_;
};
