...
from apc_manipulation.msg import RetreatAction, RetreatActionFeedback
...
class RetreatArm:
    ...
    def __init__(self, name):
        ...
        self._action_server = actionlib.SimpleActionServer(self._action_name,
                                                           ...
                                                           auto_start=False)
        self._feedback = RetreatActionFeedback()
    ...
    def actionlib_callback(self, goal):
        ...
        if not preemption and not aborted:
...
if __name__ == '__main__':
    rospy.init_node('RetreatNode')
    approach_server = RetreatArm("/apc/manipulation/retreat")
