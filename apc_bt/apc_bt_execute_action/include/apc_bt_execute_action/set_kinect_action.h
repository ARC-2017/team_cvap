#ifndef __APC_BT_SET_KINECT_ACTION__
#define __APC_BT_SET_KINECT_ACTION__
#include <ros/ros.h>
...
namespace apc
{
class SetKinectAction : ROSAction
{
public:
  SetKinectAction(std::string node_name, std::string bt_name);
  ~SetKinectAction()
  {
  }
...
bool SetKinectAction::isSystemActive()
{
  bool running;
